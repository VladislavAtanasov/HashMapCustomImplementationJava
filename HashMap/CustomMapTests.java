...
public class CustomMapTests extends TestCase {
	...
	public void testPutIfAbsent() {
		map.put("Hash", 21);
		map.put("Levski", 52);
		assertEquals((Object) 11, map.putIfAbsent("HashMap", 11));
		assertEquals(null, map.putIfAbsent("Levski", 32));
	}
